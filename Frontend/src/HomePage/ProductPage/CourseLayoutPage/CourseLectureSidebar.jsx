...
export function CourseLectureSidebar({
  ...
  if (!lessons.length) return <p>Loading lectures...</p>;
  ...
  const handleLectureClick = (lesson, idx) => {
    ...
    navigate(
      `/course/${courseId}/module/${currentModuleId}/lecture/${lesson._id}`
    );
            ...
            <div key={lesson._id}>
              ...
              >
                ...
                <div className="csb-lesson-left">
                  ...
                  <span className="csb-lesson-title">
                    {lesson.title}
                  </span>
                ...
                <span className="csb-duration">
                  ...
                  <button className="csb-demo-button">
                    Demo Video
                  </button>
              ...
              {expandedLessonIndex === idx &&
                lesson.subtitles?.map((subtitle, subIdx) => (
                  ...
                  <div
                    key={`${idx}-${subIdx}`}
                    className="csb-subtitle-item"
                  >

                    <span className="csb-subtitle-text">
                      {subtitle}
                    </span>

                    <span className="csb-subtitle-duration">
                      {lesson.duration}
                    </span>
